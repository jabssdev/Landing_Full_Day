                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="periodo" class="form-control">
                                        <option value="{{ $curso->periodo }}" selected>{{ $curso->periodo }}
                                        </option>
                        ...
                        <div class="form-group">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="descripcion" id="descripcion" class="form-control" cols="30" rows="10" required>{{ $curso->descripcion }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="file" name="pdf" data-allowed-file-extensions='pdf'
                                        ...
                                        data-default-file="{{ asset('/pdf_img/' . $curso->pdf) }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="file" name="video" data-allowed-file-extensions='mp4 avi mkv'
                                        id="input-file-now" class="dropify"
                                        data-default-file="{{ asset('/video_img/' . $curso->video) }}">
                                </div>
                            </div>
                        </div>
                        <br>
