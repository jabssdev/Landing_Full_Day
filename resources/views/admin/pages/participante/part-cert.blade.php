        ...
        <div class="card">
            <div class="header row">
                <div class="col-lg-6 col-sm-8">
                    <h2 style="padding-top:5px;">Participante</h2>
                </div>
                            ...
                            <tr class="gradeA">
                                ...
                                <td style="text-align: center">
                                    <div class="media-object">
                                        <img src="{{ asset('/participante_img/participante_1678411895.jpg') }}"
                                            alt="" width="100px">
                                    </div>
                                </td>
                                <td style="text-align: center">Roger Junior</td>
                                <td style="text-align: center">Segura Mendez</td>
                                <td style="text-align: center">999999999</td>
                                <td style="text-align: center">12345678</td>
                                <td style="text-align: center">Ing. Mecatrónica</td>
                                <td style="text-align: center">
                                    <div class="media-object">
                                        <img src="{{ asset('/admin/assets/imagenes/QR.png') }}" alt=""
                                            width="100px">
                                    </div>
                                </td>
                                ...
                                <td class="actions" style="padding: 20px !important;text-align:center;">
                                    <a href="#" class="btn btn-success" title="Añdir Certificado">
                                        <i class="fa fa-certificate"></i>
                                    </a>&nbsp;
                                    <a href="#" class="btn btn-warning" title="Lista de cursos">
                                        <i class="fa fa-book"></i>
                                    </a>&nbsp;
                                    <a href="#" class="btn btn-info" title="Editar">
                                        <i class="fa fa-edit"></i>
                                    </a>&nbsp;
                                    <a href="#" class="btn btn-danger js-sweetalert button" data-id=""
                                        title="Eliminar">
