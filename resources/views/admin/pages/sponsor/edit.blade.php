        ...
        <div class="row">
            <div class="col-lg-5 col-md-8 col-sm-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Editar Sponsor</li>
                </ul>
            </div>
        </div>
    </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="file" name="imagen" data-allowed-file-extensions='jpg png'
                                        ...
                                        data-default-file="{{ asset('/sponsor_img/' . $sponsor->imagen) }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6">
                                    <label>Ruta</label>
                                    <input type="text" name="ruta" class="form-control" value="{{ $sponsor->ruta }}">
                                </div>
                            </div>
                        </div>
                        <br>
