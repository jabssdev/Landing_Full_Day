                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="file" name="imagen" data-allowed-file-extensions='jpg png'
                                        ...
                                        data-default-file="{{ asset('/noticia_img/' . $noticia->imagen) }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="descripcion" id="summary-ckeditor" class="form-control" cols="30" rows="10">{{ $noticia->descripcion }}</textarea>
                                </div>
                            </div>
                        </div>
                        <br>
                        <button type="submit" class="btn btn-primary">Guardar</button>
                        <a type="button" href="{{ route('noticia.index') }}" class="btn btn-secondary">Cancelar</a>
                    </form>
                </div>
            </div>
        </div>
