...
!(function (e, i) {
        ...
        if (
            ...
            var s = {
                ...
                messages: {
                    ...
                    replace: "Arrastrar y soltar o hacer click para reemplazar",
                    remove: "Eliminar",
                ...
                error: {
                    ...
                    fileExtension:
                        "The file is not allowed ({{ value }} only).",
                },
                tpl: {
    ...
    return (
        ...
        (i.prototype.setPreview = function (i, t) {
            ...
            if ((this.hideLoader(), i === !0)) {
                ...
                this.settings.height &&
                    r.css("max-height", this.settings.height),
                    r.appendTo(s);
            } else
            ...
            if (0 === this.errorsEvent.errors.length) {
                ...
                this.input.trigger(i, [this]),
                    i.result !== !1 &&
                        ...
                        this.input.val(""),
                        this.resetPreview(),
                        this.input.trigger(e.Event("dropify.afterClear"), [
                            this,
                        ]));
        ...
        (i.prototype.isImage = function () {
            return "-1" !=
                this.settings.imgFileExtensions.indexOf(this.getFileType())
                ? !0
                : !1;
        }),
        (i.prototype.isFileExtensionAllowed = function () {
            return "-1" != this.settings.allowedFileExtensions.indexOf("*") ||
                "-1" !=
                    this.settings.allowedFileExtensions.indexOf(
                        this.getFileType()
                    )
                ? !0
        ...
        (i.prototype.validateImage = function () {
            0 !== this.settings.minWidth &&
                ...
                "-1" ==
                    this.settings.allowedFormats.indexOf(
                        this.getImageFormat()
